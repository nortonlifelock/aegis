...
CREATE PROCEDURE `UpdateAssetIDOsTypeIDOfDevice` (_ID NVARCHAR(36), _AssetID NVARCHAR(36), _ScannerSourceID VARCHAR(36), _GroupID VARCHAR(100), _OS VARCHAR(300), _HostName VARCHAR(1000), _OsTypeID INT, _OrgID NVARCHAR(36))
  #BEGIN#
  UPDATE Device D
