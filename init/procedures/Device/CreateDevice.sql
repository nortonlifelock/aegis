...
CREATE PROCEDURE `CreateDevice`(_AssetID NVARCHAR(36), _SourceID VARCHAR(36), _Ip NVARCHAR(32), _Hostname VARCHAR(1000), _MAC VARCHAR(100), _GroupID VARCHAR(100), _OrgID NVARCHAR(36), _OS VARCHAR(300), _OSTypeID INT)
  #BEGIN#
