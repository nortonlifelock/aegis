...
CREATE PROCEDURE `CreateDevice`(_AssetID NVARCHAR(360), _SourceID VARCHAR(36), _Ip NVARCHAR(32), _Hostname VARCHAR(1000), inInstanceID VARCHAR(200), _MAC VARCHAR(100), _GroupID VARCHAR(100), _OrgID NVARCHAR(36), _OS VARCHAR(300), _OSTypeID INT, inTrackingMethod VARCHAR(100))
  #BEGIN#
