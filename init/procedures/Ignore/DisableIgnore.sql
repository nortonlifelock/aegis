...
CREATE PROCEDURE `DisableIgnore`(inSourceID VARCHAR(36), inDevID VARCHAR(36), inOrgID VARCHAR(36), inVulnID NVARCHAR(255), inPortID NVARCHAR(150), inUpdatedBy NVARCHAR(255))
    #BEGIN#
BEGIN
