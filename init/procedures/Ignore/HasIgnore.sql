...
CREATE PROCEDURE `HasIgnore`(inSourceID VARCHAR(36), inVulnID NVARCHAR(255), inDevID VARCHAR(300), inOrgID VARCHAR(36), inPort NVARCHAR(150), inMostCurrentDetection DATETIME)
  #BEGIN#
  SELECT
    ID,
    SourceID,
