...
CREATE PROCEDURE `GetAllExceptions`( _offset INT, _limit INT,_sourceID VARCHAR(36), _orgID VARCHAR(36), _typeID INT,_vulnID NVARCHAR(255), _devID VARCHAR(36), _dueDate DATETIME, _port NVARCHAR(150), _approval  NVARCHAR(120),
