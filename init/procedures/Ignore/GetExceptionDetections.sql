...
BEGIN
    ...
    ORDER BY
        ...
        CASE WHEN _sortField = 'osregex' AND _sortOrder='ASC' THEN Dev.OS END,
        CASE WHEN _sortField = 'ignoretype' AND _sortOrder='ASC' THEN I.TypeId END,
        ...
        CASE WHEN _sortField = 'osregex' AND _sortOrder='DESC' THEN Dev.OS END DESC,
        CASE WHEN _sortField = 'ignoretype' AND _sortOrder='ASC' THEN I.TypeID END DESC
