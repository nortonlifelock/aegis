...
CREATE PROCEDURE `UpdateDetectionTimesSeen` (_DeviceID NVARCHAR(36), _VulnID NVARCHAR(36), _Port INT, _Protocol VARCHAR(36), _ExceptionID VARCHAR(36), _TimesSeen INT, _StatusID INT)
    #BEGIN#
UPDATE Detection D
