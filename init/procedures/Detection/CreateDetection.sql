...
CREATE PROCEDURE `CreateDetection`(_OrgID NVARCHAR(36), _SourceID NVARCHAR(36), _DeviceID NVARCHAR(36), _VulnID NVARCHAR(36), _IgnoreID NVARCHAR(36), _AlertDate DATETIME, _LastFound DATETIME, _LastUpdated DATETIME, _Proof MEDIUMTEXT, _Port INT, _Protocol VARCHAR(40), _ActiveKernel INT, _DetectionStatusID INT, _TimesSeen INT, _DefaultTime DATETIME)
    #BEGIN#
