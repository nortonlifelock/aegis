...
DROP PROCEDURE IF EXISTS `GetPendingActiveCloudDecomJob`;

CREATE PROCEDURE `GetPendingActiveCloudDecomJob` (_OrgID VARCHAR(36))
    #BEGIN#
SELECT
    JH.Id,
    JH.JobId,
...
WHERE JC.OrganizationId = _OrgID
  and (J.Struct = 'CloudDecommissionJob')
