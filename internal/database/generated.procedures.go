...
import (
	...
	"github.com/nortonlifelock/pkg/domain"
	"time"
)
...
func (conn *dbconn) CreateTicket(_Title string, _Status string, _DetectionID string, _OrganizationID string, _DueDate time.Time, _UpdatedDate time.Time, _ResolutionDate time.Time, _ExceptionDate time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error) {

	conn.Exec(&connection.Procedure{
		Proc:       "CreateTicket",
		Parameters: []interface{}{_Title, _Status, _DetectionID, _OrganizationID, _DueDate, _UpdatedDate, _ResolutionDate, _ExceptionDate, _DefaultTime},
		Callback: func(results interface{}, dberr error) {
			err = dberr
...
func (conn *dbconn) GetDetectionInfoForGroupAfter(_LastUpdatedAfter time.Time, _LastFoundAfter time.Time, _OrgID string, inGroupID string, ticketInactiveKernels bool) ([]domain.DetectionInfo, error) {
	...
	conn.Read(&connection.Procedure{
		...
		Parameters: []interface{}{_LastUpdatedAfter, _LastFoundAfter, _OrgID, inGroupID, ticketInactiveKernels},
		Callback: func(results interface{}, dberr error) {
			err = dberr
...
func (conn *dbconn) UpdateTicket(_Title string, _Status string, _OrganizationID string, _AssignmentGroup string, _Assignee string, _DueDate time.Time, _CreatedDate time.Time, _UpdatedDate time.Time, _ResolutionDate time.Time, _ExceptionDate time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error) {

	conn.Exec(&connection.Procedure{
		Proc:       "UpdateTicket",
		Parameters: []interface{}{_Title, _Status, _OrganizationID, _AssignmentGroup, _Assignee, _DueDate, _CreatedDate, _UpdatedDate, _ResolutionDate, _ExceptionDate, _DefaultTime},
		Callback: func(results interface{}, dberr error) {
			err = dberr
