...
type MockSQLDriver struct {
	...
	FuncCreateTicket                                  func(_Title string, _Status string, _DetectionID string, _OrganizationID string, _DueDate time.Time, _UpdatedDate time.Time, _ResolutionDate time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error)
	...
	FuncUpdateTicket                                  func(_Title string, _Status string, _OrganizationID string, _AssignmentGroup string, _Assignee string, _DueDate time.Time, _CreatedDate time.Time, _UpdatedDate time.Time, _ResolutionDate time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error)
...
func (myMockSQLDriver *MockSQLDriver) CreateTicket(_Title string, _Status string, _DetectionID string, _OrganizationID string, _DueDate time.Time, _UpdatedDate time.Time, _ResolutionDate time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error) {
	if myMockSQLDriver.FuncCreateTicket != nil {
		return myMockSQLDriver.FuncCreateTicket(_Title, _Status, _DetectionID, _OrganizationID, _DueDate, _UpdatedDate, _ResolutionDate, _DefaultTime)
	} else {
		panic("method not implemented") // mock SQL drivers should only be used in testing
	}
}
...
func (myMockSQLDriver *MockSQLDriver) GetDetectionInfoForGroupAfter(_After time.Time, _OrgID string, inGroupID string, ticketInactiveKernels bool) ([]domain.DetectionInfo, error) {
	if myMockSQLDriver.FuncGetDetectionInfoForGroupAfter != nil {
		return myMockSQLDriver.FuncGetDetectionInfoForGroupAfter(_After, _OrgID, inGroupID, ticketInactiveKernels)
	} else {
		panic("method not implemented") // mock SQL drivers should only be used in testing
	}
}
...
func (myMockSQLDriver *MockSQLDriver) UpdateTicket(_Title string, _Status string, _OrganizationID string, _AssignmentGroup string, _Assignee string, _DueDate time.Time, _CreatedDate time.Time, _UpdatedDate time.Time, _ResolutionDate time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error) {
	if myMockSQLDriver.FuncUpdateTicket != nil {
		return myMockSQLDriver.FuncUpdateTicket(_Title, _Status, _OrganizationID, _AssignmentGroup, _Assignee, _DueDate, _CreatedDate, _UpdatedDate, _ResolutionDate, _DefaultTime)
	} else {
		panic("method not implemented") // mock SQL drivers should only be used in testing
	}
}
