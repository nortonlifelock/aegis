...
type GeneratedDatabaseConnection interface {
	...
	CreateVulnInfoNoCVSS3(_SourceVulnID string, _Title string, _SourceID string, _CVSSScore float32, _Description string, _Threat string, _Solution string, _Software string, _DetectionInformation string) (id int, affectedRows int, err error)
	...
	UpdateVulnByID(_ID string, _SourceVulnID string, _Title string, _SourceID string, _CVSSScore float32, _CVSS3Score float32, _Description string, _Threat string, _Solution string, _Software string, _DetectionInformation string) (id int, affectedRows int, err error)
	UpdateVulnByIDNoCVSS3(_ID string, _SourceVulnID string, _Title string, _SourceID string, _CVSSScore float32, _Description string, _Threat string, _Solution string, _Software string, _DetectionInformation string) (id int, affectedRows int, err error)
