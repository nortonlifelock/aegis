...
type GeneratedDatabaseConnection interface {
	...
	CreateTicket(_Title string, _Status string, _DetectionID string, _OrganizationID string, _DueDate time.Time, _UpdatedDate time.Time, _ResolutionDate time.Time, _ExceptionDate time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error)
	...
	CreateVulnInfo(_SourceVulnID string, _Title string, _SourceID string, _CVSSScore float32, _CVSS3Score float32, _Description string, _Threat string, _Solution string, _Software string, _Patchable string, _Category string, _DetectionInformation string) (id int, affectedRows int, err error)
	...
	GetChildDetectionsForDetectionID(_ID string) ([]DetectionInfo, error)
	...
	GetDetectionInfoByIPVulnID(_IP string, _VulnID string) ([]DetectionInfo, error)
	...
	GetDeviceInfoByScannerSourceID(_IP string, _GroupID string, _OrgID string) (DeviceInfo, error)
	...
	GetTicketByDetectionID(inDetectionID string, _OrgID string) (TicketSummary, error)
	...
	GetTicketByIPVulnID(_IP string, _VulnID string) ([]TicketSummary, error)
	...
	GetTicketTrackingMethod(_Title string, _OrgID string) (KeyValue, error)
	...
	UpdateAssetGroupLastTicket(inGroupID string, inOrgID string, inLastTicketTime time.Time) (id int, affectedRows int, err error)
	UpdateAssetIDOsTypeIDOfDevice(_ID string, _AssetID string, _ScannerSourceID string, _GroupID string, _OS string, _HostName string, _OsTypeID int, inTrackingMethod string, _OrgID string) (id int, affectedRows int, err error)
	UpdateDetection(_ID string, _DeviceID string, _VulnID string, _Port int, _Protocol string, _ExceptionID string, _TimesSeen int, _StatusID int, _LastFound time.Time, _LastUpdated time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error)
	UpdateDetectionIgnore(_DeviceID string, _VulnID string, _Port int, _Protocol string, _ExceptionID string) (id int, affectedRows int, err error)
	...
	UpdateTicket(_Title string, _Status string, _OrganizationID string, _AssignmentGroup string, _Assignee string, _DueDate time.Time, _CreatedDate time.Time, _UpdatedDate time.Time, _ResolutionDate time.Time, _ExceptionDate time.Time, _DefaultTime time.Time) (id int, affectedRows int, err error)
	UpdateTicketDetectionID(_Title string, _DetectionID string, _OrganizationID string) (id int, affectedRows int, err error)
